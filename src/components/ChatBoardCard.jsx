    ...
    const arrArticle = [
        {
            tag: '步行者',
            key: '1',
            user_img: `${import.meta.env.BASE_URL}/images/avatar/Avatar-1.png`,
            username: "Huli123",
            title: "現場聽橋讚爆了!",
        ...
        },
        {
            tag: '生祥樂隊',
            key: '2',
            user_img: `${import.meta.env.BASE_URL}/images/avatar/Avatar-2.png`,
            ...
            pic: `${import.meta.env.BASE_URL}/images/樂迷留言板/種樹與野生.jpg`,
            number: ['673', '56', '45']
        },
        {
            tag: '打狗祭',
            key: '3',
            user_img: `${import.meta.env.BASE_URL}/images/avatar/Avatar-3.png`,
            username: "Huanglala789",
            title: "周邊用搶的，好難!!",
            content: "打狗祭的周邊真的是難買到嚇死人，預售沒跟到，開賣後也沒有搶到><，要不是強者我朋友，我可能就買不到了。建議有計畫購買打狗祭周邊商品的朋友下次一定要趁早上網訂購啊!",
            pic: `${import.meta.env.BASE_URL}/images/樂迷留言板/留言附圖_音樂祭單品_1.jfif`,
            number: ['98', '6', '18']
        },
        {
            tag: '洪佩瑜',
            key: '4',
            user_img: `${import.meta.env.BASE_URL}/images/avatar/Avatar-4.png`,
        ...
        },
        {
            tag: '巴大雄',
            key: '5',
            user_img: `${import.meta.env.BASE_URL}/images/avatar/Avatar-5.png`,
            username: "BigBearFan",
            title: "巴大雄的溫暖夜晚!",
        ...
        },
        {
            tag: '揪音秘',
            key: '6',
            user_img: `${import.meta.env.BASE_URL}/images/avatar/Avatar-6.png`,
            username: "IndieFan33",
            title: "揪音秘演唱會相關問題求助！",
        ...
        },
        {
            tag: '秋波愛麗',
            key: '7',
            user_img: `${import.meta.env.BASE_URL}/images/avatar/Avatar-7.png`,
            username: "IndieLove_22",
            title: "秋波愛麗的夢幻現場!!",
            content: "秋波愛麗的現場氣氛太美了，燈光、音樂和他們的表演融合得無比自然！特別是那首慢板曲《銀河之聲》，直接把大家帶到另一個次元。現場粉絲都超安靜，好像怕打擾到這份美好。",
            pic: `${import.meta.env.BASE_URL}/images/樂迷留言板/留言附圖_專場_2.jfif`,
            number: ['418', '40', '279']
        },
        {
            tag: '刑男大主廚',
            key: '8',
            user_img: `${import.meta.env.BASE_URL}/images/avatar/Avatar-8.png`,
            username: "ChefFan_66",
            title: "刑男大主廚的瘋狂夜",
        ...
        },
        {
            tag: '',
            key: '9',
            user_img: `${import.meta.env.BASE_URL}/images/avatar/Avatar-9.png`,
            username: "Lisa098",
            title: "關於聽團穿搭這件事",
            content: "一直都不是個會在意穿搭的人直到開始聽團之後，看到朋友們去聽團錢都會用心搭配穿著，增加聽團的儀式感，我也慢慢受到影響......",
            pic:`${import.meta.env.BASE_URL}/images/樂迷留言板/留言附圖_音樂祭單品_2.jfif`,
            number: ['108', '30', '38']
        },
    ]
                                ...
                                <div className="text-area">
                                    ...
                                    <div className="feedback">
                                        <div className="icon-number">
                                            <figure><img src={`${import.meta.env.BASE_URL}/images/icon/icon-chat.svg`} /></figure>
                                            <p>{article.number[0]}</p>
                                        </div>
                                        <div className="icon-number">
                                            <figure><img src={`${import.meta.env.BASE_URL}/images/icon/icon-heart-outline.svg`} /></figure>
                                            <p>{article.number[1]}</p>
                                        </div>
                                        <div className="icon-number">
                                            <figure><img src={`${import.meta.env.BASE_URL}/images/icon/icon-bookmark.svg`} /></figure>
