                ...
                <div className="cube-left">
                    <Link to='/search' className='row-left-up'>
                        <figure className="cube1 cube-btn">
                            <img className='texture' src="/public/images/texture.png" alt="背景材質" />
                            <img className='logo' src="/public/images/logo.svg" alt="隨Band地圖logo" />
                        </figure>
                        <figure className="cube2 cube-btn">
                            <img className='texture' src="/public/images/texture.png" alt="背景材質" />
                            <img src="/public/images/logo.svg" alt="隨Band地圖logo" /></figure>
                    </Link>
                            ...
                            <div className="row-2">
                                <div className="row-right-left">
                                    <div className='row-right-left-up'>
                                        <figure className="cube6"><img src="/public/images/line.svg" alt="" /></figure>
