...
function CurrentEvent() {
    ...
    // 樂團介紹卡片array
    const arrEventCard = [
        { img: `${import.meta.env.BASE_URL}/images/近期活動-揪音秘.jpg`, key: '1', name: '近期活動-揪音秘', event: '揪音秘', time: '2024/11/10 (日）', place: 'Legacy Taipei 音樂展演空間' },

        { img: `${import.meta.env.BASE_URL}/images/近期活動-刑男大主廚.jpg`, key: '2', name: '近期活動-刑男大主廚', event: '刑男大主廚', time: '2024/11/24 (日）', place: 'Legacy Taipei 音樂展演空間' },

        { img: `${import.meta.env.BASE_URL}/images/近期活動-開往天堂的海盜船.jpg`, key: '3', name: '近期活動-開往天堂的海盜船', event: '開往天堂的海盜船', time: '2024/11/29 (五）', place: 'Legacy Taipei 音樂展演空間' },
    ]
    ...
    return (
        <div id="currentevent-page">
            ...
            <div className="intro-section">
                ...
                <div className="cta">
                    <span>點進探索</span>
                    <Link to='/event'><button className="cta-btn"><img src={`${import.meta.env.BASE_URL}/images/btn-next-w&p.svg`} alt="" /></button></Link>
                </div>
            </div>
        </div>
    )
